...
class UnetGenerator(nn.Module):
    def __init__(self, input_nc, output_nc, num_downs, ngf=64,
        ...
        unet_block = UnetSkipConnectionBlock(output_nc, ngf, input_nc=input_nc, submodule=unet_block, outermost=True, norm_layer=norm_layer, final_activation='tanh')
    ...
    def __init__(self, outer_nc, inner_nc, input_nc=None,  final_activation='tanh',
        ...
        if outermost:
            ...
            if final_activation == 'tanh':
                ...
                up += [nn.Sigmoid()]
            # else:            
            #     NotImplementedError('final activation [%s] is not implemented' % final_activation)
